...
const PRECACHE_URLS = [
  ...
  '/sound/tick.opus',
  '/sound/tick2.opus',
  '/sound_google_ja_ato.opus',
  '/sound_google_ja_choudo.opus',
  '/sound_google_ja_go.opus',
  '/sound_google_ja_gofun.opus',
  '/sound_google_ja_gogo.opus',
  '/sound_google_ja_goji.opus',
  '/sound_google_ja_gojuppun.opus',
  '/sound_google_ja_gojuu.opus',
  '/sound_google_ja_gojuubyou.opus',
  '/sound_google_ja_gozen.opus',
  '/sound_google_ja_happun.opus',
  '/sound_google_ja_hatiji.opus',
  '/sound_google_ja_ippun.opus',
  '/sound_google_ja_itiji.opus',
  '/sound_google_ja_juppun.opus',
  '/sound_google_ja_juu.opus',
  '/sound_google_ja_juubyou.opus',
  '/sound_google_ja_juuji.opus',
  '/sound_google_ja_kuji.opus',
  '/sound_google_ja_kyuufun.opus',
  '/sound_google_ja_nanafun.opus',
  '/sound_google_ja_ni.opus',
  '/sound_google_ja_nifun.opus',
  '/sound_google_ja_niji.opus',
  '/sound_google_ja_nijuppun.opus',
  '/sound_google_ja_nijuu.opus',
  '/sound_google_ja_nijuu_ji.opus',
  '/sound_google_ja_nijuubyou.opus',
  '/sound_google_ja_nijuuji.opus',
  '/sound_google_ja_osirase.opus',
  '/sound_google_ja_reiji.opus',
  '/sound_google_ja_rokuji.opus',
  '/sound_google_ja_roppun.opus',
  '/sound_google_ja_san.opus',
  '/sound_google_ja_sanji.opus',
  '/sound_google_ja_sanjuppun.opus',
  '/sound_google_ja_sanjuu.opus',
  '/sound_google_ja_sanjuubyou.opus',
  '/sound_google_ja_sanpun.opus',
  '/sound_google_ja_sitiji.opus',
  '/sound_google_ja_yoji.opus',
  '/sound_google_ja_yon.opus',
  '/sound_google_ja_yonjuppun.opus',
  '/sound_google_ja_yonjuu.opus',
  '/sound_google_ja_yonjuubyou.opus',
  '/sound_google_ja_yonpun.opus',
